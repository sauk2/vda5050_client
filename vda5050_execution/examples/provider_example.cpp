...
using Provider = vda5050_execution::Provider;

struct PositionData
: public vda5050_execution::Initialize<PositionData, UpdateBase>
{
  double x;
  double y;
...
: public vda5050_execution::Initialize<DiagnosticData, UpdateBase>
{
