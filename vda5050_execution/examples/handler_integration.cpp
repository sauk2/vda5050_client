...
using Handler = vda5050_execution::Handler;
using Priority = vda5050_execution::Priority;

struct ConfigResource
: public vda5050_execution::Initialize<ConfigResource, ResourceBase>
{
...
struct OrderEvent : public vda5050_execution::Initialize<OrderEvent, EventBase>
{
  std::string order_id;
  uint32_t sequence_id;
  std::string node_id;
