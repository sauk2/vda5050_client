...
#ifndef VDA5050_EXECUTION__HANDLER__HANDLER_HPP_
#define VDA5050_EXECUTION__HANDLER__HANDLER_HPP_
...
public:
  ...
  static std::shared_ptr<Handler> make(
    std::shared_ptr<core::ContextInterface> context,
  ...
  void add_strategy(std::shared_ptr<core::StrategyInterface> strategy);

  void remove_strategy(std::shared_ptr<core::StrategyInterface> strategy);
...
private:
  ...
  std::shared_ptr<core::ContextInterface> context_;

  std::vector<std::shared_ptr<core::StrategyInterface>> strategies_;
...
#endif  // VDA5050_EXECUTION__HANDLER__HANDLER_HPP_
