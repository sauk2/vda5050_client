...
protected:
  ...
  vda5050_types::Edge e2_{"edge2", 2, "node1", "node5", true, {}, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt};
  vda5050_types::Node n3_{"node3", 3, true, {}, std::nullopt, std::nullopt};
  vda5050_types::Edge e4_{"edge4", 4, "node1", "node5", true, {}, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt, std::nullopt};
...
TEST_F(OrderGraphValidatorTest, IncorrectNumberOfNodesAndEdgesTest)
{
  ...
  vda5050_types::Node n6 = vda5050_types::Node{"node6", 6, true, {}, std::nullopt, std::nullopt};
  nodes.push_back(n6);
